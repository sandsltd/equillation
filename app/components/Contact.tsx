            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@equillation.com</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-primary-50 to-sage-50 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Stay updated on workshops, training opportunities, and insights about 
                  equine facilitated constellation work.
                </p>
                <a href="#" className="btn-secondary text-sm py-2 px-4 inline-block">
